...
typedef struct IssTrackerApp { IssPosition current; IssPosition trail[ISS_TRAIL_MAX]; UWORD trail_head; UWORD trail_count; UBYTE show_trail; UBYTE auto_update; UBYTE blink; UBYTE status; UBYTE light_state; UBYTE surface_state; UBYTE status_page; char status_text[80]; char info_text[128]; WORD win_left; WORD win_top; WORD win_width; WORD win_height; UWORD update_interval_min; } IssTrackerApp;
